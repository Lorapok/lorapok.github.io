...
exports.CAPACITY_PROFILES = exports.FREE_AI_PROVIDERS_DIRECTORY = void 0;
exports.formatComprehensiveReport = formatComprehensiveReport;
exports.FREE_AI_PROVIDERS_DIRECTORY = [
    {
...
function formatComprehensiveReport() {
    let r = "=================================================================================\n";
    ...
    r += "---------------------------------------------------------------------------------\n";
    for (const item of exports.FREE_AI_PROVIDERS_DIRECTORY) {
