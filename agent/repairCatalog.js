...
async function main() {
    ...
    if (posts[0]) {
        ...
        if (ref1 !== -1 && keyTakeaways !== -1 && ref2 > keyTakeaways) {
            ...
            posts[0].citations = (0, writer_1.extractCitationsFromMarkdown)(posts[0].content);
        ...
        if (!hasConclusion || isUnclosed) {
            ...
            try {
                ...
                if (completion) {
                    ...
                    merged = (0, writer_1.spliceConclusionCleanly)(merged, completion);
                    ...
                    p.content = merged;
                    p.citations = (0, writer_1.extractCitationsFromMarkdown)(merged);
