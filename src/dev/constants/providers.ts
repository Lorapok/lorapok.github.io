...
export const AI_PROVIDERS: AIProvider[] = [
  ...
  { id: "gemini", label: "Gemini", color: "#34d399", model: "gemini-3.8-flash", apiType: "gemini", endpoint: "https://generativelanguage.googleapis.com/v1beta", availableModels: ["gemini-3.8-flash", "gemini-3.8-pro", "gemini-3.1-pro-preview", "gemini-pro-latest", "gemini-flash-latest"] },
